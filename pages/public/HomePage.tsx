        ...
        <>
            ...
            <section className="py-16">
                <div className="text-center mb-8">
                    <div className="inline-flex items-center gap-3 text-gray-800 text-lg">
                    ...
                    <h2 className="text-3xl font-serif text-gray-800 mt-2">Follow Me On Instagram</h2>
                    <p className="text-gray-600 mt-2">Stay updated with our latest stories and behind-the-scenes content</p>
                </div>
                <div className="flex w-full overflow-x-auto space-x-2">
                    {[...Array(6)].map((_, i) => (
                        <div key={i} className="flex-shrink-0 w-1/5">
                            <div className="w-full aspect-square bg-gray-300 border border-white hover:opacity-80 transition-opacity cursor-pointer"></div>
                        </div>
                    ))}
                </div>
            </section>
