...
export const GlobeAltIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c.507 0 1.009-.036 1.5-.106M12 21a8.956 8.956 0 0 1-1.5-.106M5.284 15.253A8.956 8.956 0 0 1 12 3c1.905 0 3.68.58 5.166 1.538M5.284 15.253A8.956 8.956 0 0 0 3 12c0 1.905.58 3.68 1.538 5.166m-1.48-3.418a.75.75 0 0 1 1.06 0l4.33 4.33a.75.75 0 0 1-1.06 1.06l-4.33-4.33a.75.75 0 0 1 0-1.06Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3a8.956 8.956 0 0 1 5.166 1.538m0 0A8.956 8.956 0 0 1 21 12c0 1.905-.58 3.68-1.538 5.166m-1.48-3.418a.75.75 0 0 1 1.06 0l-4.33 4.33a.75.75 0 0 1-1.06-1.06l4.33-4.33a.75.75 0 0 1 0-1.06Z" />
    </svg>
);
...
export const EyeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.644l.662-1.034c.528-.822 1.571-1.295 2.573-1.295h13.492c1.002 0 2.045.473 2.573 1.295l.662 1.034a1.012 1.012 0 0 1 0 .644l-.662 1.034c-.528.822-1.571-1.295-2.573-1.295H5.271c-1.002 0-2.045-.473-2.573-1.295l-.662-1.034Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
    </svg>
);
...
export const FacebookIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className || 'w-4 h-4'} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
    </svg>
);

export const TwitterIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className || 'w-4 h-4'} fill="currentColor" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-1.78 12.95h1.98L4.03 1.85H1.89l8.93 11.85Z" />
    </svg>
);
